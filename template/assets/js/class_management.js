...
<tr class="collapse" id="c${course_id}">
    <td name = "${course_id}">
        <textarea id="${course_id}_info" cols="30" rows="1" class = "my-3" requried>${course_info}</textarea>
        <textarea id="${course_id}_price" cols="30" rows="3" class = "my-3" requried>${course_price}</textarea>
