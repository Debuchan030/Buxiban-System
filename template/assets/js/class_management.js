...
<tr class="collapse" id="c${course_id}">
    <td name = "${course_id}">
        <textarea id="${course_id}_info" cols="30" rows="1" class = "my-3" required>${course_info}</textarea>
        <textarea id="${course_id}_price" cols="30" rows="3" class = "my-3" required>${course_price}</textarea>
        <input id="${course_id}_time" class = "my-3" type = "number" required >${course_time}</textarea>
